...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', required=True, help='path to images (should have subfolders train/A, train/B, val/A, val/B, test/A, test/B for np_array_aligned)')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='np_array_aligned', help='chooses how datasets are loaded. [np_array_aligned]')
